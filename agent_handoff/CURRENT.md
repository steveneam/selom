...
> piecemeal — then `#1(d)`, then `#5`.** `API_ONLY_KNOBS` is **73 across 11 skills**.
...
> 3. ~~**`#1(c)` `gsea` + `ssgsea` (13)**~~ — **DONE 2026-08-05.** 86 → 73 knobs, 13 → 11 skills.
...
1. **⇒ KEEP WORKING DOWN `API_ONLY_KNOBS` — 171 → 148 (`f7d5756`) → 91 (`98e29ce`) → 86 (`bf6a686`)
   → 73 (`f0e150b`); 36 skills → 27 → 14 → 13 → 11.** ~~`volcano`~~ · ~~the over-representation trio~~ · ~~`proteomics_de`~~ · ~~the cheap
