...
## ▸ LIVE · PHASE-F1-F2 · 2026-08-03 18:05 +1000 (Sydney) · branch `main` (**unpushed — owner pushes**) · Claude (FE+BE, solo, lead)
...
- **Owner-facing, end of session:** a root-level **`Data for Steven/`** now signposts the ERG
  ...
  **0.12–0.15 for a real rescued eye**; `AWAVE_MAX_RATIO = 0.18` is now a **ceiling**, so an
  ...
  The flash threshold was checked and was **already correct**. Lines thickened + scale bar moved in.
