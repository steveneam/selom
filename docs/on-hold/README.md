...
| **External-tool builds (ARCHS4 / phylogenomics / eggNOG)** | Off-thesis breadth; ARCHS4 data non-commercial, the others AGPL. | `docs/external-tools-study.md`, [[selom-external-tools-study]] | — (mostly skip) |
...
| **Gene-set builder — messy multi-header lists** | Phase A shipped clean lists; messy parsing deferred. | `docs/gene-set-builder-design.md`, [[selom-gene-set-builder]] | P4 (later) |
