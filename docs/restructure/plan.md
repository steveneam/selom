...
| — | **WS1.3** | Backend-ci green: WS1.1 prod-guard vs the extras-less CI closure | P0 | DONE — ff12198 | NEW (CI red on every push since WS1.1) |
...
### WS2.5 — QC coverage vs deliberately-broken real data · P1 · Status: DONE — 1be0a6b
...
### WS2.6 — Unify the run-path error taxonomy · P2 · Status: DONE — e3e707f
...
### WS1.3 — Backend-ci green: WS1.1 prod-guard vs the extras-less CI closure · P0 · Status: DONE — ff12198
